...
$reasontomeet=$_POST['reasontomeet'];
 $query=mysqli_query($con,"insert into visitor(VisitorName,MobileNumber,Address,WhomtoMeet,ReasontoMeet,Building,Department) value('$visname','$mobnumber','$add','$whomtomeet','$reasontomeet','$building','$depart')");
...
<div class="row form-group">
 <div class="col col-md-3">
<label for="password-input" class=" form-control-label">Building Name</label>
 </div>
<div class="col-12 col-md-9">
<select name="building" id="building" placeholder="Building Name" class="form-control">
  <option value="Main Building">Main Building</option>
  <option value="Dronagiri">Dronagiri</option>
  <option value="Work Shop">Work Shop</option>
  <option value="Sajjangad Hostel">Sajjangad Hostel</option>
  <option value="Sinhgad Hostel">Sinhgad Hostel</option>
  <option value="Kalsubai Hostel">Kalsubai Hostel</option>
...
<div class="row form-group">
 <div class="col col-md-3">
<label for="password-input" class=" form-control-label">Department Name</label>
 </div>
<div class="col-12 col-md-9">
<select type="text" name="department" id="department" placeholder="Department Name" class="form-control" required="true">
