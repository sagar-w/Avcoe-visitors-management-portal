...
<body class="animsition">
                        ...
                        <div class="login-form">
                            <form action="" method="post" name="login">
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" id="username" type="text" name="username" placeholder="UserName" required="true">
                                </div>
                                <div class="form-group">
   ...
   <center> <div>Copyright © AVCOE 2020  </div></center>
                        </div>
                    </div>
                </div>
            </div>
